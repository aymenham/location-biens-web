...
<html>
<head>
<title>Réservations d'un bien</title>
<meta charset="utf-8">
	...
	<div class="main">
		<div class="container-fluid">
			<div class="row">
				...
				<br>
				<br>
				<h4 align="center">Les réservations du bien : ${sessionScope.titre}</h4>
				<br>
					<div id="content">
												...
												<tr>
													...
													<td><form method="POST"
															...
															<input type="hidden" name="idBien"
																...
																type="Submit" value="Consulter le bien"  class="btn btn-secondary" id="sub">
														</form></td>
												</tr>
											</c:if>
									</c:forEach>
