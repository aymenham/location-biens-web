...
<body>
	...
	<div id="content" class="col-12 col-md-8 col-lg-9 mt-3">
		<table id="myTable" class="table table-striped table-bordered"
			...
			<tbody>
				<c:forEach var="client" items="${sessionScope.ListClient}">
					<tr>
						<td>${client.pseudo}</td>
						<td>${client.nom}</td>
						<td>${client.prenom}</td>
						...
						<td><form method="POST" align="center"
								...
								<input type="hidden" name="hidden" value="DebloquerClient">
								<input type="Submit" class="btn btn-success" value="Debloquer"
									id="sub">
							</form></td>
					</tr>
				</c:forEach>
